...
public class MainViewPelanggan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pelangganView1 = new rahmayudhip.latihanmvcjdbc.view.PelangganView();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("APLIKASI MANAGEMENT");
        setBackground(new java.awt.Color(255, 242, 230));

        pelangganView1.setBackground(new java.awt.Color(251, 255, 230));
    ...
    private rahmayudhip.latihanmvcjdbc.view.PelangganView pelangganView1;
